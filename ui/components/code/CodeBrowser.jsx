            ...
            <DialogContent className="max-w-lg p-0 overflow-hidden gap-0">
                ...
                <div className="relative px-4 py-3">
                    ...
                    <input
                        ...
                        className="w-full pl-7 pr-3 py-1.5 text-sm bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:border-transparent"
                        autoFocus
                    />
                </div>
